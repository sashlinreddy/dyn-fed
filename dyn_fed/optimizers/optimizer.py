...
class OptimizerV1():
    ...
    def __init__(self, loss, learning_rate, **kwargs):
        ...
        self._logger = logging.getLogger(f"dfl.optimizers.{self.__class__.__name__}")
...
class SGD(Optimizer):
    ...
    def compute_gradients(self, model, y, y_pred):
        ...
        Args:
            y (dyn_fed.operators.Tensor): Actual labels
            y_pred (dyn_fed.operators.Tensor): Predicted labels
        """
    ...
    def apply_gradients(self, model, **kwargs):
        ...
        Args:
            model (dyn_fed.Model): Tensor model containing multiple layers
        """
