...
from dyn_fed.activations.activation import Linear, ReLU, Sigmoid
...
class Layer():
    ...
    Attributes:
        ...
        W (dfl.Tensor): Parameter tensor
        b (dfl.Tensor): Bias vector
        activation (str): Activation function
        dtype (type): Type of tensors
    """
    def __init__(self, n_inputs, n_outputs, W=None, b=None, activation="sigmoid", dtype=np.float32):
        # Private
        self._logger = logging.getLogger(f'dfl.layers.{self.__class__.__name__}')
        self._dtype = dtype
        # Public
    ...
    def __call__(self, value):
        ...
        Args:
            value (dfl.Tensor): Input tensor to perform feedforward on

        Returns:
            y (dfl.Tensor): Output tensor
        """
