...
# git clone git@github.com:sashlinreddy/dyn-fed.git
...
./dyn-fed/scripts/compile_proto.sh

echo 'export PROTOBUF_HOME=$HOME/protoc-3.10.1/' >> ~/.bashrc
echo 'export PATH=${PROTOBUF_HOME}/bin:${PATH}' >> ~/.bashrc

# scp gcp
# gcloud compute scp data/mnist/*.gz g1-login1:/home/g675723_students_wits_ac_za/dyn-fed/data/mnist
# gcloud compute scp data/fashion-mnist/*.gz g1-login1:/home/g675723_students_wits_ac_za/dyn-fed/data/fashion-mnist
